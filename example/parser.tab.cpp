...
static const char *const yytname[] =
{
  ...
  "MINUS", "MULTIPLY", "DIVIDE", "LPAREN", "RPAREN", "END", "UMINUS",
  "$accept", "input", "expression", "term", "factor", YY_NULLPTR
};
...
#line 38 "parser.ypp"
               {
        std::cout << "Result: " << (yyvsp[0].number) << std::endl; 
